...
data.frame(lower = I[1], upper = I[2], conf.level = conf.level, row.names = "Prop Confidence Interval:")
}
...
data.frame(lower = I[1], upper = I[2], conf.level = conf.level, row.names = "Cohen's d Confidence Interval:")
}
