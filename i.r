...
deci <- function(x, k = 3) format(round(x, k), nsmall = k)                                                                                                                           
  ...
  if(!pr){  
    ...
    axis(2, at = 1:loop, lab = substring(d, 2), font = 2, las = 1, cex.axis = .8, tick = FALSE, mgp = c(2, .3, 0))
...
d.priors <- function(t, n1, n2 = NA, m, s, lo = -Inf, hi = Inf, dist.name, scale = 1, margin = 7, top = .8, show.prior = FALSE, LL = -3, UL = 3, bottom = 1){
  ...
  if(!pr){
    ...
    axis(2, at = 1:loop, lab = substring(d, 2), font = 2, las = 1, cex.axis = .8, tick = FALSE, mgp = c(2, .5, 0))
